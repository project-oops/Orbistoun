//! `libSceRemoteplay` - remote play.
//!
//! **2 names, declared and not implemented.** They come from PPSA02664's own import table (2).
//!
...
guest_module! {
    "libSceRemoteplay" {
        "sceRemoteplayGetConnectionStatus" => 6,
        "sceRemoteplayInitialize" => 6,
    }
}
